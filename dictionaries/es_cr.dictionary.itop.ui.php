...
Dict::Add('ES CR', 'Spanish', 'Español, Castellano', array(
	...
	'Menu:WelcomeMenu+' => 'Bienvenido a AT-WFM', // Duplicated into itop-welcome-itil (will be removed from here...)
...
<li>Administrar el bien más importante de su infraestructura de TI: La Documentación.</li>
	...
	'UI:Login:Welcome' => 'Bienvenido a AT-WFM',
	...
	'UI:LogOff:ThankYou' => 'Gracias por usar AT-WFM',
...
'UI:RequestMgmtMenuOverview:Title' => 'Panel de Control para Administración de S&OT',
'UI-RequestManagementOverview-RequestByService' => 'S&OT por Servicio',
'UI-RequestManagementOverview-RequestByPriority' => 'S&OT por Prioridad',
'UI-RequestManagementOverview-RequestUnassigned' => 'S&OT Sin Asignar a un Analista',
...
Cuando se asocien con un disparador, cada acción recibe un número de "orden", esto especifica en que orden se ejecutaran las acciones.</p>',
	...
	'Portal:ShowOngoing' => 'Mostrar S&OT Abiertos',
	'Portal:ShowClosed' => 'Mostrar S&OT Cerrados',
	'Portal:CreateNewRequest' => 'Crear S&OT',
	'Portal:ChangeMyPassword' => 'Cambiar Contrase&ntilde;a',
	'Portal:Disconnect' => 'Cerrar Sesión',
	'Portal:OpenRequests' => 'Mis S&OT Abiertos',
	'Portal:ClosedRequests'  => 'Mis S&OT Cerrados',
	'Portal:ResolvedRequests'  => 'Mis S&OT Solucionados',
	...
	'Portal:DescriptionOfTheRequest' => 'Captura una Descripción para tu S&OT:',
	'Portal:TitleRequestDetailsFor_Request' => 'Detalles del S&OT %1$s:',
	'Portal:NoOpenRequest' => 'No hay S&OT para esta Categoría',
	'Portal:NoClosedRequest' => 'No hay S&OT para esta Categoría',
	'Portal:Button:ReopenTicket' => 'Reabrir este Ticket',
	'Portal:Button:CloseTicket' => 'Cerrar este Ticket',
	'Portal:Button:UpdateRequest' => 'Actualizar el S&OT',
