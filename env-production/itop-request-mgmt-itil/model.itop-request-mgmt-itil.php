<?php
//
// File generated by ... on the 2020-03-18T17:06:01+0100
// Please do not edit manually
//

/**
 * Classes and menus for itop-request-mgmt-itil (version 2.2.0)
 *
...
define('PORTAL_USERREQUEST_FORM_ATTRIBUTES', 'title,description,urgency,departamento,municipio,latitud,longitud,direccion,num_ot,tipo_acceso,medidas_feeders,tipo_tecnologia,num_instal,nom_cliente,nom_contacto,tel_contacto,fecha_ejecucion');
...
define('PORTAL_USERREQUEST_DETAILS_ZLIST', '{"col:left":["ref","caller_id","servicesubcategory_id","title","description","direccion","departamento","municipio","latitud","longitud","num_ot","tipo_acceso","medidas_feeders","tipo_tecnologia","num_instal","nom_cliente","nom_contacto","tel_contacto","fecha_ejecucion","solution"],"col:right":["status","priority","start_date","resolution_date","last_update","agent_id"]}');
...
class UserRequest extends Ticket
{
	public static function Init()
	{
		...
		MetaModel::Init_AddAttribute(new AttributeEnum("impact", array("allowed_values"=>new ValueSetEnum("1,2,3"), "display_style"=>'list', "sql"=>'impact', "default_value"=>'2', "is_null_allowed"=>false, "depends_on"=>array(), "always_load_in_tables"=>false)));
		...
		MetaModel::Init_AddAttribute(new AttributeEnum("tipo_pendiente", array("allowed_values"=>new ValueSetEnum("Falta Recurso Humano,Falta Recurso Físico"), "display_style"=>'list', "sql"=>'tipo_pendiente', "default_value"=>'', "is_null_allowed"=>true, "depends_on"=>array(), "always_load_in_tables"=>false)));
		...
		MetaModel::Init_AddAttribute(new AttributeString("num_orden_compra", array("allowed_values"=>null, "sql"=>'num_orden_compra', "default_value"=>'Diligenciar por encargado de facturación', "is_null_allowed"=>true, "depends_on"=>array(), "always_load_in_tables"=>false)));
		MetaModel::Init_AddAttribute(new AttributeString("grn", array("allowed_values"=>null, "sql"=>'grn', "default_value"=>'Diligenciar por encargado de facturación', "is_null_allowed"=>true, "depends_on"=>array(), "always_load_in_tables"=>false)));
		MetaModel::Init_AddAttribute(new AttributeEnum("dictamen_tecnico", array("allowed_values"=>new ValueSetEnum("Si,No"), "display_style"=>'list', "sql"=>'dictamen_tecnico', "default_value"=>'No', "is_null_allowed"=>true, "depends_on"=>array(), "always_load_in_tables"=>false)));
		MetaModel::Init_AddAttribute(new AttributeString("direccion", array("allowed_values"=>null, "sql"=>'direccion', "default_value"=>'', "is_null_allowed"=>false, "depends_on"=>array(), "always_load_in_tables"=>false)));
		MetaModel::Init_AddAttribute(new AttributeString("num_ot", array("allowed_values"=>null, "sql"=>'num_ot', "default_value"=>'', "is_null_allowed"=>false, "depends_on"=>array(), "always_load_in_tables"=>false)));
		MetaModel::Init_AddAttribute(new AttributeString("num_instal", array("allowed_values"=>null, "sql"=>'num_instal', "default_value"=>'', "is_null_allowed"=>false, "depends_on"=>array(), "always_load_in_tables"=>false)));
		MetaModel::Init_AddAttribute(new AttributeString("nom_cliente", array("allowed_values"=>null, "sql"=>'nom_cliente', "default_value"=>'', "is_null_allowed"=>false, "depends_on"=>array(), "always_load_in_tables"=>false)));
		MetaModel::Init_AddAttribute(new AttributeString("nom_contacto", array("allowed_values"=>null, "sql"=>'nom_contacto', "default_value"=>'', "is_null_allowed"=>false, "depends_on"=>array(), "always_load_in_tables"=>false)));
		MetaModel::Init_AddAttribute(new AttributeString("tel_contacto", array("allowed_values"=>null, "sql"=>'tel_contacto', "default_value"=>'', "is_null_allowed"=>false, "depends_on"=>array(), "always_load_in_tables"=>false)));
		MetaModel::Init_AddAttribute(new AttributeDateTime("fecha_ejecucion", array("allowed_values"=>null, "sql"=>'fecha_ejecucion', "default_value"=>'', "is_null_allowed"=>false, "depends_on"=>array(), "always_load_in_tables"=>false)));
		MetaModel::Init_AddAttribute(new AttributeString("departamento", array("allowed_values"=>null, "sql"=>'departamento', "default_value"=>'', "is_null_allowed"=>true, "depends_on"=>array(), "always_load_in_tables"=>false)));
		MetaModel::Init_AddAttribute(new AttributeString("municipio", array("allowed_values"=>null, "sql"=>'municipio', "default_value"=>'', "is_null_allowed"=>true, "depends_on"=>array(), "always_load_in_tables"=>false)));
		MetaModel::Init_AddAttribute(new AttributeDecimal("latitud", array("allowed_values"=>null, "sql"=>'latitud', "default_value"=>'', "is_null_allowed"=>true, "depends_on"=>array(), "digits"=>16, "decimals"=>8, "always_load_in_tables"=>false)));
		MetaModel::Init_AddAttribute(new AttributeDecimal("longitud", array("allowed_values"=>null, "sql"=>'longitud', "default_value"=>'', "is_null_allowed"=>true, "depends_on"=>array(), "digits"=>16, "decimals"=>8, "always_load_in_tables"=>false)));
		MetaModel::Init_AddAttribute(new AttributeEnum("tipo_acceso", array("allowed_values"=>new ValueSetEnum("Llave Maestra,Llave Multilook,Carta Especial,Otros"), "display_style"=>'list', "sql"=>'tipo_acceso', "default_value"=>'Otros', "is_null_allowed"=>true, "depends_on"=>array(), "always_load_in_tables"=>false)));
		MetaModel::Init_AddAttribute(new AttributeEnum("tipo_tecnologia", array("allowed_values"=>new ValueSetEnum("2G,3G,LTE,Otros"), "display_style"=>'list', "sql"=>'tipo_tecnologia', "default_value"=>'Otros', "is_null_allowed"=>true, "depends_on"=>array(), "always_load_in_tables"=>false)));
		MetaModel::Init_AddAttribute(new AttributeEnum("medidas_feeders", array("allowed_values"=>new ValueSetEnum("7/8,1 5/8,1/2,FO,Otros"), "display_style"=>'list', "sql"=>'medidas_feeders', "default_value"=>'Otros', "is_null_allowed"=>true, "depends_on"=>array(), "always_load_in_tables"=>false)));
		MetaModel::Init_AddAttribute(new AttributeHTML("link_modulo", array("allowed_values"=>null, "sql"=>'link_modulo', "default_value"=>'', "is_null_allowed"=>true, "depends_on"=>array(), "always_load_in_tables"=>false)));
		MetaModel::Init_AddAttribute(new AttributeHTML("link_venta", array("allowed_values"=>null, "sql"=>'link_venta', "default_value"=>'', "is_null_allowed"=>true, "depends_on"=>array(), "always_load_in_tables"=>false)));
		MetaModel::Init_AddAttribute(new AttributeString("email", array("allowed_values"=>null, "sql"=>'email', "default_value"=>'', "is_null_allowed"=>false, "depends_on"=>array(), "always_load_in_tables"=>false)));
		MetaModel::Init_AddAttribute(new AttributeDecimal("latitud_llegada", array("allowed_values"=>null, "sql"=>'latitud_llegada', "default_value"=>'', "is_null_allowed"=>true, "depends_on"=>array(), "digits"=>16, "decimals"=>8, "always_load_in_tables"=>false)));
		MetaModel::Init_AddAttribute(new AttributeDecimal("longitud_llegada", array("allowed_values"=>null, "sql"=>'longitud_llegada', "default_value"=>'', "is_null_allowed"=>true, "depends_on"=>array(), "digits"=>16, "decimals"=>8, "always_load_in_tables"=>false)));
		...
		MetaModel::Init_DefineState(
			...
			array(
				...
				"attribute_list" => array(
					...
					'tipo_pendiente' => OPT_ATT_HIDDEN,
					'user_satisfaction' => OPT_ATT_HIDDEN,
					'user_comment' => OPT_ATT_HIDDEN,
					'num_orden_compra' => OPT_ATT_HIDDEN,
					'grn' => OPT_ATT_HIDDEN,
					'dictamen_tecnico' => OPT_ATT_HIDDEN,
		...
		MetaModel::Init_DefineTransition("escalated_tto", "ev_assign", array("target_state"=>"assigned", "actions"=>array(array('verb' => 'SetCurrentDate', 'params' => array(array('type' => 'attcode', 'value' => "assignment_date")))), "user_restriction"=>null));
		MetaModel::Init_DefineState(
			"assigned",
			array(
				"attribute_inherit" => 'new',
		...
		MetaModel::Init_DefineTransition("approved", "ev_assign", array("target_state"=>"assigned", "actions"=>array(array('verb' => 'SetCurrentDate', 'params' => array(array('type' => 'attcode', 'value' => "assignment_date")))), "user_restriction"=>null));
		MetaModel::Init_DefineTransition("approved", "ev_autoresolve", array("target_state"=>"resolved", "actions"=>array(array('verb' => 'SetCurrentDate', 'params' => array(array('type' => 'attcode', 'value' => "resolution_date"))), array('verb' => 'SetElapsedTime', 'params' => array(array('type' => 'attcode', 'value' => "time_spent"), array('type' => 'attcode', 'value' => "start_date"), array('type' => 'string', 'value' => "DefaultWorkingTimeComputer"))), array('verb' => 'ResolveChildTickets', 'params' => array())), "user_restriction"=>null));
		MetaModel::Init_DefineState(
			"rejected",
			array(
				"attribute_inherit" => 'new',
		...
		MetaModel::Init_DefineState(
			...
			array(
				...
				"attribute_list" => array(
					...
					'tipo_pendiente' => OPT_ATT_MANDATORY | OPT_ATT_MUSTPROMPT,
					'ttr_escalation_deadline' => OPT_ATT_HIDDEN,
				),
			)
		);
		...
		MetaModel::Init_DefineState(
			...
			array(
				...
				"attribute_list" => array(
					...
					'departamento' => OPT_ATT_READONLY,
					'municipio' => OPT_ATT_READONLY,
					'latitud' => OPT_ATT_READONLY,
					'longitud' => OPT_ATT_READONLY,
					'direccion' => OPT_ATT_READONLY,
					'num_ot' => OPT_ATT_READONLY,
					'num_instal' => OPT_ATT_READONLY,
					'nom_cliente' => OPT_ATT_READONLY,
					'nom_contacto' => OPT_ATT_READONLY,
					'tel_contacto' => OPT_ATT_READONLY,
					'fecha_ejecucion' => OPT_ATT_READONLY,
					...
					'tipo_pendiente' => OPT_ATT_READONLY,
		...
		MetaModel::Init_DefineState(
			...
			array(
				...
				"attribute_list" => array(
					...
					'num_orden_compra' => OPT_ATT_MUSTPROMPT,
					'grn' => OPT_ATT_MUSTPROMPT,
					'dictamen_tecnico' => OPT_ATT_MUSTPROMPT,
				),
			)
		);
		...
		MetaModel::Init_DefineHighlightScale( array(
		    'warning' => array('rank' => 1, 'color' => HILIGHT_CLASS_WARNING, 'icon' => utils::GetAbsoluteUrlModulesRoot().'itop-request-mgmt-itil/images/user-request-deadline.png'),
		    'critical' => array('rank' => 2, 'color' => HILIGHT_CLASS_CRITICAL, 'icon' => utils::GetAbsoluteUrlModulesRoot().'itop-request-mgmt-itil/images/user-request-escalated.png'),
		    'closed' => array('rank' => 3, 'color' => HILIGHT_CLASS_NONE, 'icon' => utils::GetAbsoluteUrlModulesRoot().'itop-request-mgmt-itil/images/user-request-closed.png'),
		));
  ...
  24 => 'priority',
  25 => 'service_id',
  26 => 'servicesubcategory_id',
  27 => 'team_id',
  28 => 'agent_id',
  29 => 'escalation_flag',
  30 => 'resolution_code',
  31 => 'user_satisfaction',
  32 => 'sla_tto_passed',
  33 => 'sla_ttr_passed',
));
