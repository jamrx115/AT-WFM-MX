<?php
//
// File generated by ... on the 2020-03-18T19:31:15+0100
...
class UserRequest extends Ticket
{
	public static function Init()
	{
		...
		MetaModel::Init_AddAttribute(new AttributeString("latitud", array("allowed_values"=>null, "sql"=>'latitud', "default_value"=>'', "is_null_allowed"=>true, "depends_on"=>array(), "always_load_in_tables"=>false)));
		MetaModel::Init_AddAttribute(new AttributeString("longitud", array("allowed_values"=>null, "sql"=>'longitud', "default_value"=>'', "is_null_allowed"=>true, "depends_on"=>array(), "always_load_in_tables"=>false)));
		...
		MetaModel::Init_AddAttribute(new AttributeString("link_modulo", array("allowed_values"=>null, "sql"=>'link_modulo', "default_value"=>'', "is_null_allowed"=>true, "depends_on"=>array(), "always_load_in_tables"=>false)));
